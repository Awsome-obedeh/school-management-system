      ...
      <td className='py-3'>
        <div className='flex gap-3 bg-red-500'>
          ...
          <Image src={item.photo} alt={item.name}
            width={30}
            height={30}
            className=' bg-green-600 md:hidden xl:block w-30 h-0 rounded-full object-cover'></Image>
  ...
  return (
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
      ...
      <div className="flex justify-between items-center ">
        <h2 className="hidden md:block font-semibold tex-lg pr-3">All Studemts</h2>
